export default {
  ...
  tiers: {
    title: 'Transfer Tiers',
    subtitle: 'Configure CP thresholds and capacity per tier for each season.',
    add_btn: 'Add Tier',
    add_title: 'Add Tier',
    edit_title: 'Edit Tier',
    no_data: 'No tiers yet. Add one to start.',
    ...
    cp_range: 'CP Range',
    capacity: 'Capacity',
    delete_title: 'Delete Tier',
    delete_desc: 'This tier will be permanently deleted. This cannot be undone.',
  },
  guest_home: {
